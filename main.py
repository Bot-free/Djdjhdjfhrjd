...
##################################
                        ...
                        if b"/like" in dataS and comand ==True:
                            ...
                            BesTo_msg(f"""[b][c]{generate_random_color()}{like}""", dataS.hex(), client)                               
...
################################ 
                        ...
                        if b"/spammm" in dataS and comand ==True:
                            ...
                            BesTo_msg(f"""[b][c]{generate_random_color()}\n\n- {spam} \n\n""", dataS.hex(), client)        
...
##################################
                        ...
                        if b'/LAG FREE' in dataS:
                            while True:
                                ...
                                ################################                                                     	      	      	      	      	     	      	      	
                        if b'/help' in dataS:
                            BesTo_msg(f"""{generate_random_color()}\n\n- Welcome To TMK BOT PRO!\n\n""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()}\n- مميزات واوامر البوت :\n""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} خمسة اشخاص في الفريق  :  {generate_random_color()}\n\n- /5sㅤㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()}  ستة اشخاص في الفريق  :  {generate_random_color()}\n\n- /6sㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()}  زيادة 100 لايك  :  {generate_random_color()}\n\n- /like[id]ㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} سبام طلبات صداقه : {generate_random_color()}\n\n- /spam[id]ㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} صديق الوهمي : {generate_random_color()}\n\n- /frㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} لوغو البسي : {generate_random_color()}\n\n- /pc[id]ㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} جواهر وهمية  : {generate_random_color()}\n\n- /dmㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} غولد وهمي  :  {generate_random_color()}\n\n- /goldㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} سبام طلبات الانضمام :  {generate_random_color()}\n\n  - /invㅤㅤㅤ""", dataS.hex(), client)
                            
                            BesTo_msg(f"""{generate_random_color()} الاختفاء لاعب في الفريق : {generate_random_color()}\n\n- /spyㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} الاختفاء لاعب في الروم : {generate_random_color()}\n\n- /spyromㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} رقصات مميزة : {generate_random_color()}\n\n- /A1 --> /A20ㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} رقصات اسلحة :  {generate_random_color()}\n\n- /E1 --> /E8ㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} سبام رقصات :  {generate_random_color()}\n\n- /sevㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} اضافة يوتيوبر للاصدقاء : {generate_random_color()}\n\n- /ytㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()} مطورين البوت :  {generate_random_color()}\n\n- /devㅤㅤㅤㅤ""", dataS.hex(), client)
                            BesTo_msg(f"""{generate_random_color()}[i][b][c]\n\n- Dev By : @BOT TmK\n\n""", dataS.hex(), client)
...
#################################
                        ...
                        if b'/dev' in dataS:
                            BesTo_msg(f"""{generate_random_color()} Developer Bot : \n\n\n{generate_random_color()}  Ig : @Bottmk""", dataS.hex(), client)
                                            
                                                ################################                                                                                                                                                                                             
                        
                        if b"/emmmo" in dataS:
                                BesTo_msg(f"""{generate_random_color()} رقصات مميزة\n\n{generate_random_color()}- تم تفعيل""", dataS.hex(), client)
                                BesTo_msg(f"""{generate_random_color()} طريقة الاستخدام :\n\n /A1  -->  /A20""", dataS.hex(), client)
                        
                        if b"/evo" in dataS:
                                BesTo_msg(f"""{generate_random_color()} رقصات اسلحة\n\n{generate_random_color()}- تم تفعيل""", dataS.hex(), client)
                                BesTo_msg(f"""[b][c]{generate_random_color()}- طريقة الاستخدام :\n\n /E1  -->  /E8""", dataS.hex(), client)                                                                                                                                                                                                                                                  ################################
                                                  
                                                                  
                        if b"/Run" in dataS:
                        	BesTo_msg(f"""{generate_random_color()}\n\n- Welcome To TMK BOT !\n\n""", dataS.hex(), client)
                        	BesTo_msg(f"""{generate_random_color()} القائمة الاولى : \n\n{generate_random_color()} ¦ صديق وهمي  -  /fr \n ¦ سبام طلبات الانضمام  - /inv\n ¦ خمسة في الفريق - /5s\n ¦ ستة اشخاص في الفريق  - /6s""", dataS.hex(), client)
                        	BesTo_msg(f"""{generate_random_color()} القائمة التانية : \n\n{generate_random_color()} ¦ تصفير الجواهر - /dis\n ¦ جواهر وهمية - /dm\n ¦ يوتيوبر اصدقائك  -  /yout\n ¦ اختفاء لاعب  -  /spy\n ¦ سبام طلبات صداقه - /spam[id]""", dataS.hex(), client)
                        	BesTo_msg(f"""{generate_random_color()} القائمة الثالثة : \n\n{generate_random_color()} ¦ رقصات مميزة  -  /emo\n ¦ رقصات اسلحة مطورة -  /evo\n ¦ سبام رقصات -  /sev\n ¦ زيادة 100 لايك  - /like[id]""", dataS.hex(), client)
                        	BesTo_msg(f"""{generate_random_color()} القائمة الرابعة : \n\n{generate_random_color()} ¦ لوغو البيسي - /pc[id]\n ¦ غولد وهمي - /gold\n ¦ اختفاء لاعب في الروم-  /spyrom\n ¦ مطورين البوت  -  /dev""", dataS.hex(), client)
                        	BesTo_msg(f"""{generate_random_color()} - البوت شغال يمكنك استخدام \n\nكل المميزات المعروضة امامك """, dataS.hex(), client)
                        	BesTo_msg(f"""{generate_random_color()} /sev""", dataS.hex(), client)
                        	BesTo_msg(f"""{generate_random_color()} /LAG FREE """, dataS.hex(), client)
                        	BesTo_msg(f"""{generate_random_color()} @Gr""", dataS.hex(), client)
